        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-end mb-4">
                    <Link :href="route('dashboard.movies.create')"
                          class="inline-block uppercase bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-5 rounded">Add Movie</Link>
                </div>
                ...
                <div v-if="movies.data.length > 0" class="mt-6 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                    <div v-for="movie in movies.data" :key="movie.id" class="overflow-hidden rounded-xl shadow-md hover:shadow-xl hover:scale-105 duration-200">
