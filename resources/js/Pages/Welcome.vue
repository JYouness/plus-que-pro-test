...
<template>
    ...
    <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-10">
                <h1 class="text-3xl text-center text-gray-500 dark:text-gray-400 mb-6">Trending Movies (Daily)</h1>

                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div v-if="movies.data.length > 0" class="grid grid-cols-3 gap-4">
                        <div v-for="movie in movies.data" :key="movie.id">
                            <Link :href="route('public.movies.show', {movie: movie.id})">
                                <div class="relative max-w-sm overflow-hidden rounded-xl bg-white shadow-md duration-200 hover:scale-105 hover:shadow-xl">
            ...
            <div class="flex flex-col justify-between mt-16 px-6 sm:items-center sm:justify-between">
                <div class="text-center text-sm sm:text-start text-gray-500 dark:text-gray-400">
                    <p>Plus que PRO - Test dՎvaluation</p>
                    <p>Candidat: Youness Jabboua</p>
                </div>
